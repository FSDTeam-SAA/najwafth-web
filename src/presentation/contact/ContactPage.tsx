...
export function ContactPage() {
  ...
  const contactHighlights = [
    {
      ...
      value: "booksonwheels21000@gmail.com",
      icon: Mail,
    },
    { title: t("contact.callUs"), value: "", icon: Phone },
  ...
  const fieldErrors = useMemo(() => {
    return {
      ...
      description:
        form.description.trim().length < 10 ? t("contact.errDesc") : "",
    };
  }, [form, t]);
